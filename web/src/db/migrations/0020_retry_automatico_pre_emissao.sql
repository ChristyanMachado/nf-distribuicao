-- Tarefas novas têm prioridade. Falhas transitórias pré-emissão preservam a
-- tentativa e voltam atrás das tarefas ainda não tentadas.
CREATE INDEX IF NOT EXISTS "tarefas_pendentes_retry_idx"
  ON "fiscal"."tarefas" ("tentativas", "atualizado_em", "criado_em", "id")
