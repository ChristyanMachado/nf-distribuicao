...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ erro?: string; config?: string; bloqueado?: string; retorno?: string }> }) {
      ...
      <div className="w-full max-w-sm">
        ...
        <Card className="mt-6 p-5 shadow-[0_18px_50px_rgba(36,38,31,0.08)]">
          <form action={entrar} className="space-y-4">
            ...
            <label className="block text-sm font-medium">Usuário<input name="usuario" autoComplete="username" required autoFocus className="mt-1.5 w-full" /></label>
