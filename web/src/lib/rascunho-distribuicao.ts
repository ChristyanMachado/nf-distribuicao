...
// v2 evita reutilizar rascunhos antigos com trocas avulsas, que agora exigem
// saldo previamente registrado por produto e mercado.
const PREFIXO_CHAVE = "graalyst:distribuicao:rascunho:v2";
